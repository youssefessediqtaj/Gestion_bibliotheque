<x-app-layout>
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Modifier l'emprunt</h2>
            </div>
            ...
            <form action="{{ route('emprunts.update', $emprunt) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="date_emprunt" id="date_emprunt" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('date_emprunt', $emprunt->date_emprunt) }}" required>
                </div>

                <div class="mb-4">
                    <label for="date_retour" class="block text-gray-700 text-sm font-bold mb-2">Date de retour</label>
                    <input type="date" name="date_retour" id="date_retour" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('date_retour', $emprunt->date_retour) }}" required>
                </div>
